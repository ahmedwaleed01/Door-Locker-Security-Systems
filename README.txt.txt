...
Rotates the motor for 15 seconds in the clockwise direction (CW) and displays "Door is Unlocking" on the LCD.
Holds the motor for 3 seconds.
Rotates the motor for 15 seconds in the anti-clockwise direction (A-CW) and displays "Door is Locking" on the LCD.
Change Password:
